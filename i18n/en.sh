...
MSG_USE_SYSTEMD="Use systemd unit instead of /etc/fstab"
MSG_UNIT_CREATED="Unit file created"
MSG_UNIT_ENABLED="systemd unit enabled and started"
MSG_UNIT_REMOVED="systemd unit removed"
MSG_UNIT_NAME="systemd unit name"
ERROR_ARG="Error: Unknown argument"