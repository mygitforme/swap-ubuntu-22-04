...
MSG_USE_SYSTEMD="Использовать systemd unit вместо /etc/fstab"
MSG_UNIT_CREATED="Файл unit создан"
MSG_UNIT_ENABLED="systemd unit включён и запущен"
MSG_UNIT_REMOVED="systemd unit удалён"
MSG_UNIT_NAME="Имя systemd unit"    
ERROR_ARG="Ошибка: неизвестный аргумент"